 ...
 *    snooze function will be executed asynchronously (that means that it allow different line of codes to be executed at the same time) so next would be "Step 2" followed by 
 ...
 * A. Same order as the snooze function still will remain asynchronous (In javascript, callback functions are asynchronous).
 *    Yes.  
 * 
 *******************************************************************************
 */
